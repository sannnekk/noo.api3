...
public class UserMapperProfile : Profile
{
    public UserMapperProfile()
    {
        ...
        CreateMap<UserCreationPayload, UserModel>()
            ...
            .ForMember(dest => dest.CourseStates, opt => opt.Ignore())
            .ForMember(dest => dest.CourseAudiencesAsGranter, opt => opt.Ignore())
            ...
            .ForMember(dest => dest.NooTubeVideoFavourites, opt => opt.Ignore())
