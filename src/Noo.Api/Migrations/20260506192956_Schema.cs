        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    category = table.Column<string>(type: "ENUM('UserAvatar','VideoCover','VideoRichText','CourseCover','CourseAttachment','CourseRichText','WorkRichText','ProfileBackground','AssignedWorkStudentRichText','AssignedWorkMentorRichText','AssignedWorkStudentCommentRichText','AssignedWorkMentorCommentRichText','HelpRichText')", nullable: false, collation: "utf8mb4_general_ci")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    status = table.Column<string>(type: "ENUM('Pending','Completed')", nullable: false, collation: "utf8mb4_general_ci")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    entity_id = table.Column<byte[]>(type: "BINARY(16)", nullable: true),
                    owner_id = table.Column<byte[]>(type: "BINARY(16)", nullable: false),
                    created_at = table.Column<DateTime>(type: "TIMESTAMP(6)", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    updated_at = table.Column<DateTime>(type: "TIMESTAMP(6)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<byte[]>(type: "BINARY(16)", nullable: false),
                    token = table.Column<string>(type: "VARCHAR(63)", maxLength: 63, nullable: false, collation: "utf8mb4_general_ci")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    expires_at = table.Column<DateTime>(type: "DATETIME(0)", nullable: false),
                    type = table.Column<string>(type: "ENUM('EmailVerification','EmailChange','PasswordReset')", nullable: false, collation: "utf8mb4_general_ci")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    payload = table.Column<string>(type: "VARCHAR(127)", maxLength: 127, nullable: true, collation: "utf8mb4_general_ci")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    user_id = table.Column<byte[]>(type: "BINARY(16)", nullable: false),
                    created_at = table.Column<DateTime>(type: "TIMESTAMP(6)", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    student_id = table.Column<byte[]>(type: "BINARY(16)", nullable: false),
                    main_mentor_id = table.Column<byte[]>(type: "BINARY(16)", nullable: true),
                    helper_mentor_id = table.Column<byte[]>(type: "BINARY(16)", nullable: true),
                    work_id = table.Column<byte[]>(type: "BINARY(16)", nullable: true),
                    course_work_assignment_id = table.Column<byte[]>(type: "BINARY(16)", nullable: true),
                    created_at = table.Column<DateTime>(type: "TIMESTAMP(6)", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    updated_at = table.Column<DateTime>(type: "TIMESTAMP(6)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_assigned_work_course_work_assignment_course_work_assignment_~",
                        column: x => x.course_work_assignment_id,
                        principalTable: "course_work_assignment",
                        principalColumn: "id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_assigned_work_course_work_assignment_id",
                table: "assigned_work",
                column: "course_work_assignment_id");
